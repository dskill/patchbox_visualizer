...
{    
  ...
  color.b += 1.0 * pow(smoothstep(0.035,.001, scopeline0),4.);
  color.g += 1.0 * pow(smoothstep(0.035,.001, scopeline0),4.);
	color.g += 0.2 * pow(smoothstep(0.33,.001, scopeline0),2.);
	color.b += .5 * pow(smoothstep(0.44,.001, scopeline0),2.);
